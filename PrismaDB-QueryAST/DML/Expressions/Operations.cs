...
namespace PrismaDB.QueryAST.DML
{
    ...
    public class GreaterThan : Operation
    {
        ...
        public GreaterThan(Expression left, Expression right, string aliasName)
        {
            setValue(left, right, aliasName);
        }
        ...
        {
            if (value.Length < 2)
                throw new ArgumentException("GreaterThan constructor expects 2 or 3 arguments");
        ...
        public override object Clone()
        {
            ...
            var clone = new GreaterThan(left_clone as Expression, right_clone as Expression, Alias.id);
        ...
        public override string ToString()
        {
            return DialectResolver.Dialect.GreaterThanToString(this);
        }

        public override bool Equals(object other)
        {
            if (!(other is GreaterThan otherG)) return false;

            return (this.Alias.Equals(otherG.Alias))
                && (this.left.Equals(otherG.left))
                && (this.right.Equals(otherG.right));
        }
    ...
    public class LessThan : Operation
    {
        ...
        public LessThan(Expression left, Expression right, string aliasName)
        {
            setValue(left, right, aliasName);
        }
        ...
        {
            if (value.Length < 2)
                throw new ArgumentException("LessThan constructor expects 2 or 3 arguments");
        ...
        public override object Clone()
        {
            ...
            var clone = new LessThan(left_clone as Expression, right_clone as Expression, Alias.id);
        ...
        public override string ToString()
        {
            return DialectResolver.Dialect.LessThanToString(this);
        }

        public override bool Equals(object other)
        {
            if (!(other is LessThan otherL)) return false;

            return (this.Alias.Equals(otherL.Alias))
                && (this.left.Equals(otherL.left))
                && (this.right.Equals(otherL.right));
        }
